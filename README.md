...
4. From then on, it runs quietly in the background (no console window) and empties the selected folder — all files and subfolders inside it are deleted, but the folder itself is kept — every **2 hours** (and once immediately on startup).
